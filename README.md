...
----------
[프론트엔드]
- Javascript, Typescript, React, Axios, Redux, Redux Persist

[백엔드]
- Typescript, Nest.js, TypeORM, JWT, Bcrypt, Axios, Mysql

[Deploy]
- AWS(EC2, S3, RDS, Route53, AWS CloudFront, ELB)

[Others]
- Discord, Zoom, Gitbook, DB.diagram, Pigma, Postman
